          ...
          <tbody>
            {sorted.map((d, i) => (
              <tr key={d.supplier} className={`border-b border-border/50 ${i % 2 === 0 ? "bg-muted/10" : ""}`}>
                ...
                <td className="p-4 text-right font-mono">{d.macae !== 0 ? formatCurrency(d.macae) : "-"}</td>
                <td className="p-4 text-right font-mono">{d.meb !== 0 ? formatCurrency(d.meb) : "-"}</td>
            ...
            <tr className="bg-muted/50 border-t-2 border-border">
              ...
              <td className="p-4 text-right font-mono font-bold">{formatCurrency(totalMacae)}</td>
              <td className="p-4 text-right font-mono font-bold">{formatCurrency(totalMeb)}</td>
              <td className="p-4 text-right font-mono font-bold text-primary">{formatCurrency(totalGeral)}</td>
            </tr>
          </tbody>
        </table>
      </div>
